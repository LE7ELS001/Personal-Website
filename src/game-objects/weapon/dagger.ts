...
export class Dagger extends BaseWeapon{
    ...
    constructor(
       ...
       super(sprite, weaponComponent, animationConfig, baseDamage);
        this.#weaponSprite = sprite.scene.add.sprite(0, 0, ASSET_KEYS.DAGGER, 0).setVisible(false).setOrigin(0, 1).play(ASSET_KEYS.DAGGER);        
    ...
    public attackUp(): void {
        ...
        this.#weaponSprite.setPosition(this._weaponComponent.body.position.x, this._weaponComponent.body.y)
            .setVisible(true)
            .setOrigin(0, 0)
            .setAngle(0)
            .setFlipY(false);
