...
export const ASSET_KEYS = {
  ...
  PORTFOLIO_FOREGROUND: 'PORTFOLIO_FOREGROUND',
  PORTFOLIO_MIDDLEGROUND: 'PORTFOLIO_MIDDLEGROUND',
  PORTFOLIO_MIDDLEGROUND_2: 'PORTFOLIO_MIDDLEGROUND_2',
...
export const CRYSTAL_ANIMATION_KEYS = {
  SHINING: 'Crystal_shining', 
} as const;

export const CRYSTAL_FRAME_KEYS = {
  EARTH: 'EARTH',
  CONTROLLER: 'CONTROLLER',
  MAP: 'MAP',
  BOOK: 'BOOK',
